...
client.on("message", (message) => {
  ...
  if (message.content == "!si") {
    ...
    let img = "https://cdn.discordapp.com/attachments/797773346266808332/797778544599629854/3472680786290616.png"
  ...
  if (message.content == "embed") {
    ...
    let helpImg = "https://cdn.discordapp.com/attachments/797773346266808332/797778544599629854/3472680786290616.png"
    let commandList = [
      { name: "!help", desc: "help" },
    ...
    if (message.member != null) {
      ...
      let embed = new Discord.MessageEmbed().setAuthor("공지").setColor("#186de6").setFooter(`청월봇`).setTimestamp()
